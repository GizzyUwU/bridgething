...
export type BridgeThingMeta = { bridgethingVersion: string, libbridgethingVersion: string, appName: string, appVersion: string, osName: string, osVersion: string, osDescription: string, btMac: string, serialNumber: string, fccId: string, icId: string, modelName: string, imageBuildId: string, imageBuildDate: string, imageDistro: string, imageDistroVersion: string, imageMachine: string, discord: string, credits: string, };
...
export type GatewayMeta = { adapterVersion: string, libVersion: string, libbridgethingVersion: string, appName: string, appVersion: string, osName: string, };
