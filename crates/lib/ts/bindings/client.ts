...
import type { AcceptCallAction, BridgeThingMeta, BrightnessMode, BrightnessState, BrowseResult, CallEndReason, Capabilities, CommunicationsState, ConfigEntry, Device, Diagnostics, DismissReason, DtmfTone, EndCallAction, FavoritesPage, ForwardMessage, GeoAccuracy, GeoError, HardwareState, HttpHeader, InitiateCallType, ItemKind, ItemRef, LibraryError, LogEntry, LogLevel, LogSource, NetError, NetFetchRequest, NetFetchResponse, Notification, NowPlayingUpdate, OtaError, OtaProgress, Peer, PhoneCall, PhoneCallService, PhoneError, PhoneState, PlayContext, PlayerError, PlayerState, Position, QueueItem, QueuePosition, RecommendationsResult, RepeatMode, SearchResult, StreamBegin, StreamChunk, StreamEnd, StreamError, TimeInfo, WebappError, WebappInfo, WsError, WsFrame } from "./shared";
...
export type BridgeToClientAudioMsg = { "event": "ttsStarted", "data": TtsStarted } | { "event": "ttsEnded", "data": TtsEnded } | { "event": "volumeChanged", "data": VolumeChanged };
 ...
 */
export type BridgeToClientCapabilitiesMsg = { "event": "update", "data": CapabilitiesSnapshot } | { "event": "snapshot", "data": CapabilitiesSnapshot };

export type BridgeToClientConfigMsg = { "event": "get", "data": ConfigGetReply } | { "event": "list", "data": ConfigListReply } | { "event": "changed", "data": ConfigChanged };

export type BridgeToClientGeoMsg = { "event": "position", "data": Position } | { "event": "watchReply", "data": GeoWatchReply } | { "event": "getOnceReply", "data": GeoGetOnceReply } | { "event": "errorReply", "data": GeoErrorReply };

export type BridgeToClientHardwareMsg = { "event": "ambientLightUpdate", "data": AmbientLightUpdate } | { "event": "brightnessChanged", "data": BrightnessState } | { "event": "stateReply", "data": HardwareStateReply };

export type BridgeToClientLibraryMsg = { "event": "browseReply", "data": LibraryBrowseReply } | { "event": "searchReply", "data": LibrarySearchReply } | { "event": "recommendationsReply", "data": LibraryRecommendationsReply } | { "event": "favoritesListReply", "data": LibraryFavoritesListReply } | { "event": "favoritesContainsReply", "data": LibraryFavoritesContainsReply } | { "event": "libraryErrorReply", "data": LibraryErrorReply } | { "event": "favoriteChanged", "data": FavoriteChanged };
...
export type BridgeToClientMsgData = { "type": "asset", "data": BridgeToClientAssetMsg } | { "type": "audio", "data": BridgeToClientAudioMsg } | { "type": "bluetooth", "data": BridgeToClientBluetoothMsg } | { "type": "capabilities", "data": BridgeToClientCapabilitiesMsg } | { "type": "config", "data": BridgeToClientConfigMsg } | { "type": "geo", "data": BridgeToClientGeoMsg } | { "type": "hardware", "data": BridgeToClientHardwareMsg } | { "type": "library", "data": BridgeToClientLibraryMsg } | { "type": "net", "data": BridgeToClientNetMsg } | { "type": "notifications", "data": BridgeToClientNotificationsMsg } | { "type": "peer", "data": BridgeToClientPeerMsg } | { "type": "phone", "data": BridgeToClientPhoneMsg } | { "type": "player", "data": BridgeToClientPlayerMsg } | { "type": "store", "data": BridgeToClientStoreMsg } | { "type": "system", "data": BridgeToClientSystemMsg } | { "type": "time", "data": BridgeToClientTimeMsg } | { "type": "voice", "data": BridgeToClientVoiceMsg } | { "type": "webapp", "data": BridgeToClientWebappMsg } | { "type": "forward", "data": ForwardMessage } | { "type": "error", "data": WireError } | { "type": "ack" } | { "type": "done" };

export type BridgeToClientNetMsg = { "event": "fetchReply", "data": NetFetchReply } | { "event": "fetchErrorReply", "data": NetFetchErrorReply } | { "event": "wsOpenReply", "data": NetWsOpenReply } | { "event": "wsErrorReply", "data": NetWsErrorReply } | { "event": "wsMessage", "data": NetWsMessage } | { "event": "wsClosed", "data": NetWsClosed } | { "event": "wsErrorEvent", "data": NetWsErrorEvent } | { "event": "streamBegin", "data": StreamBegin } | { "event": "streamChunk", "data": StreamChunk } | { "event": "streamEnd", "data": StreamEnd } | { "event": "streamError", "data": StreamError };

export type BridgeToClientNotificationsMsg = { "event": "posted", "data": Notification } | { "event": "updated", "data": Notification } | { "event": "removed", "data": NotificationRemoved };

export type BridgeToClientPeerMsg = { "event": "snapshot", "data": PeerSnapshotMap };

export type BridgeToClientPhoneMsg = { "event": "callStarted", "data": PhoneCall } | { "event": "callUpdated", "data": PhoneCall } | { "event": "callEnded", "data": PhoneCallEnded } | { "event": "communicationsChanged", "data": PhoneCommunicationsReply } | { "event": "stateReply", "data": PhoneStateReply } | { "event": "errorReply", "data": PhoneErrorReply };
 ...
 */
export type BridgeToClientPlayerMsg = { "event": "snapshot", "data": PlayerStateReply } | { "event": "delta", "data": NowPlayingUpdate } | { "event": "queueChanged", "data": PlayerQueueReply } | { "event": "stateReply", "data": PlayerStateReply } | { "event": "queueReply", "data": PlayerQueueReply } | { "event": "errorReply", "data": PlayerErrorReply };

export type BridgeToClientStoreMsg = { "event": "response", "data": StorageResponse };

export type BridgeToClientSystemMsg = { "event": "version", "data": BridgeThingMeta } | { "event": "diagnosticsReply", "data": DiagnosticsReply } | { "event": "logsTailReply", "data": LogsTailReply } | { "event": "logsSubscribeReply", "data": LogsSubscribeReply } | { "event": "logEntry", "data": LogEntry } | { "event": "otaProgress", "data": OtaProgress } | { "event": "otaError", "data": OtaError } | { "event": "deviceNickname", "data": DeviceNicknameReply } | { "event": "deviceNicknameChanged", "data": DeviceNicknameReply };

export type BridgeToClientTimeMsg = { "event": "changed", "data": TimeSnapshot } | { "event": "snapshot", "data": TimeSnapshot };

export type BridgeToClientVoiceMsg = { "event": "stateChanged", "data": VoiceState } | { "event": "stateReply", "data": VoiceStateReply };

export type BridgeToClientWebappMsg = { "event": "listReply", "data": WebappListReply } | { "event": "currentReply", "data": WebappCurrentReply } | { "event": "activeReply", "data": WebappActiveReply } | { "event": "iconReply", "data": WebappIconReply } | { "event": "installBeginAck", "data": WebappInstallBeginAck } | { "event": "webappError", "data": WebappError } | { "event": "activeChanged", "data": WebappActiveChanged } | { "event": "webappInstalled", "data": WebappInfo } | { "event": "webappInstallFailed", "data": WebappInstallFailed } | { "event": "webappUninstalled", "data": WebappUninstalled };
...
export type ClientToBridgeAudioMsg = { "event": "volumeUp" } | { "event": "volumeDown" } | { "event": "setVolume", "data": SetVolume } | { "event": "muteToggle" } | { "event": "setMute", "data": SetMute } | { "event": "tts", "data": Tts } | { "event": "ttsCancel", "data": TtsCancel } | { "event": "ttsCancelAll" } | { "event": "earcon", "data": Earcon };
...
export type ClientToBridgeGeoMsg = { "event": "watch", "data": GeoWatch } | { "event": "unwatch", "data": GeoUnwatch } | { "event": "getOnce", "data": GeoGetOnce };

export type ClientToBridgeHardwareMsg = { "event": "displaySetMode", "data": DisplaySetMode } | { "event": "displaySetLevel", "data": DisplaySetLevel } | { "event": "stateGet" };

export type ClientToBridgeLibraryMsg = { "event": "browse", "data": LibraryBrowse } | { "event": "search", "data": LibrarySearch } | { "event": "recommendations", "data": LibraryRecommendations } | { "event": "favoritesList", "data": LibraryFavoritesList } | { "event": "favoritesContains", "data": LibraryFavoritesContains } | { "event": "favoritesToggle", "data": FavoritesToggle } | { "event": "favoritesSet", "data": FavoritesSet } | { "event": "favoritesSetMany", "data": FavoritesSetMany };
...
export type ClientToBridgeMsgData = { "type": "asset", "data": ClientToBridgeAssetMsg } | { "type": "audio", "data": ClientToBridgeAudioMsg } | { "type": "bluetooth", "data": ClientToBridgeBluetoothMsg } | { "type": "capabilities", "data": ClientToBridgeCapabilitiesMsg } | { "type": "config", "data": ClientToBridgeConfigMsg } | { "type": "geo", "data": ClientToBridgeGeoMsg } | { "type": "hardware", "data": ClientToBridgeHardwareMsg } | { "type": "library", "data": ClientToBridgeLibraryMsg } | { "type": "net", "data": ClientToBridgeNetMsg } | { "type": "notifications", "data": ClientToBridgeNotificationsMsg } | { "type": "phone", "data": ClientToBridgePhoneMsg } | { "type": "player", "data": ClientToBridgePlayerMsg } | { "type": "store", "data": ClientToBridgeStoreMsg } | { "type": "system", "data": ClientToBridgeSystemMsg } | { "type": "time", "data": ClientToBridgeTimeMsg } | { "type": "voice", "data": ClientToBridgeVoiceMsg } | { "type": "webapp", "data": ClientToBridgeWebappMsg } | { "type": "forward", "data": ForwardMessage };

export type ClientToBridgeNetMsg = { "event": "fetch", "data": NetFetch } | { "event": "wsOpen", "data": NetWsOpen } | { "event": "wsClose", "data": NetWsClose } | { "event": "wsSend", "data": NetWsSend } | { "event": "streamOpen", "data": NetStreamOpen } | { "event": "streamCancel", "data": NetStreamCancel };

export type ClientToBridgeNotificationsMsg = { "event": "invokePositive", "data": NotificationInvoke } | { "event": "invokeNegative", "data": NotificationInvoke };

export type ClientToBridgePhoneMsg = { "event": "answer", "data": PhoneCallAction } | { "event": "accept", "data": PhoneAcceptAction } | { "event": "decline", "data": PhoneCallAction } | { "event": "end", "data": PhoneCallAction } | { "event": "endTyped", "data": PhoneEndAction } | { "event": "hold", "data": PhoneCallAction } | { "event": "unhold", "data": PhoneCallAction } | { "event": "initiate", "data": PhoneInitiateAction } | { "event": "swap" } | { "event": "merge" } | { "event": "mute", "data": PhoneMuteAction } | { "event": "dtmf", "data": PhoneDtmfAction } | { "event": "stateGet" };

export type ClientToBridgePlayerMsg = { "event": "play", "data": PlayUri } | { "event": "queue", "data": QueueUri } | { "event": "pause" } | { "event": "resume" } | { "event": "skipNext" } | { "event": "skipPrev" } | { "event": "skipToIndex", "data": SkipToIndex } | { "event": "seekTo", "data": SeekTo } | { "event": "setShuffle", "data": SetShuffle } | { "event": "setRepeat", "data": SetRepeat } | { "event": "setSpeed", "data": SetSpeed } | { "event": "setCrossfade", "data": SetCrossfade } | { "event": "stateGet" } | { "event": "queueGet" };

export type ClientToBridgeStoreMsg = { "event": "get", "data": KVGet } | { "event": "put", "data": KVPut } | { "event": "delete", "data": KVDelete };

export type ClientToBridgeSystemMsg = { "event": "versionRequest" } | { "event": "diagnosticsGet" } | { "event": "logsTail", "data": LogsTail } | { "event": "logsSubscribe", "data": LogsSubscribe } | { "event": "logsUnsubscribe", "data": LogsUnsubscribe } | { "event": "reboot" } | { "event": "powerOff" } | { "event": "factoryReset" } | { "event": "deviceGetNickname" };

export type ClientToBridgeTimeMsg = { "event": "get" };

export type ClientToBridgeVoiceMsg = { "event": "cancel" } | { "event": "pushToTalk" } | { "event": "muteMic", "data": MicMute } | { "event": "unmuteMic", "data": MicUnmute } | { "event": "stateGet" };

export type ClientToBridgeWebappMsg = { "event": "list" } | { "event": "current" } | { "event": "activate", "data": WebappActivate } | { "event": "icon", "data": WebappIcon } | { "event": "installBegin", "data": WebappInstallBegin } | { "event": "installChunk", "data": WebappInstallChunk } | { "event": "installAbandon", "data": WebappInstallAbandon };
...
export type NetWsOpen = { connectionId: string, url: string, protocols: Array<string> | null, headers: Array<HttpHeader> | null, };
...
export type PhoneInitiateAction = { kind: InitiateCallType, destinationId: string | null, service: PhoneCallService | null, addressBookId: string | null, };
