...
import type { BridgeThingMeta, ForwardMessage, GatewayMeta, NowPlayingUpdate, WebappInfo } from "./shared";
...
export type GatewayToBridgeMsgData = { "type": "version", "data": GatewayMeta } | { "type": "file", "data": GatewayToBridgeFileMsg } | { "type": "chrome", "data": GatewayToBridgeChromeMsg } | { "type": "webapp", "data": GatewayToBridgeWebappMsg } | { "type": "forward", "data": ForwardMessage } | { "type": "nowPlayingUpdate", "data": NowPlayingUpdate } | { "type": "error", "data": GatewayError };
