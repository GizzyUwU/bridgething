...
import type { AcceptCallAction, AncsAuthState, AssetRetention, BridgeThingMeta, BrowseResult, CallEndReason, CommunicationsState, CompanionAuthorityScope, ConfigEntry, DismissReason, DtmfTone, EndCallAction, FavoritesPage, ForwardMessage, GatewayCapabilities, GeoAccuracy, GeoError, HttpHeader, InitiateCallType, ItemKind, ItemRef, LibraryError, NetError, NetFetchRequest, NetFetchResponse, Notification, NowPlayingUpdate, OtaError, OtaKind, OtaProgress, PhoneCall, PhoneCallService, PhoneState, PlayContext, PlayerState, Position, QueueItem, QueuePosition, RangePart, RangeSpec, RecommendationsResult, RepeatMode, SearchResult, StreamBegin, StreamChunk, StreamEnd, StreamError, TimeInfo, TunnelClosed, TunnelData, TunnelError, WebappError, WebappInfo, WsError, WsFrame } from "./shared";
 ...
 */
export type AssetPushBegin = { id: string, expectedSize: number, expectedSha256: string | null, mime: string | null, retention: AssetRetention, };
...
export type BridgeToGatewayAssetMsg = { "event": "request", "data": AssetRequest } | { "event": "pushBeginAck", "data": AssetPushBeginAck } | { "event": "pushBeginRejected", "data": AssetPushBeginRejected };

export type BridgeToGatewayAudioMsg = { "event": "volumeUp" } | { "event": "volumeDown" } | { "event": "setVolume", "data": SetVolume } | { "event": "muteToggle" } | { "event": "setMute", "data": SetMute } | { "event": "tts", "data": Tts } | { "event": "ttsCancel", "data": TtsCancel } | { "event": "ttsCancelAll" } | { "event": "earcon", "data": Earcon };

export type BridgeToGatewayGeoMsg = { "event": "watch", "data": GeoWatch } | { "event": "unwatch" } | { "event": "getOnce", "data": GeoGetOnce };

export type BridgeToGatewayLibraryMsg = { "event": "browse", "data": LibraryBrowseRequest } | { "event": "search", "data": LibrarySearchRequest } | { "event": "recommendations", "data": LibraryRecommendationsRequest } | { "event": "favoritesList", "data": LibraryFavoritesListRequest } | { "event": "favoritesContains", "data": LibraryFavoritesContainsRequest } | { "event": "favoritesToggle", "data": FavoritesToggle } | { "event": "favoritesSet", "data": FavoritesSet } | { "event": "favoritesSetMany", "data": FavoritesSetMany };
...
export type BridgeToGatewayMsgData = { "type": "version", "data": BridgeThingMeta } | { "type": "asset", "data": BridgeToGatewayAssetMsg } | { "type": "audio", "data": BridgeToGatewayAudioMsg } | { "type": "geo", "data": BridgeToGatewayGeoMsg } | { "type": "library", "data": BridgeToGatewayLibraryMsg } | { "type": "lyrics", "data": BridgeToGatewayLyricsMsg } | { "type": "net", "data": BridgeToGatewayNetMsg } | { "type": "notifications", "data": BridgeToGatewayNotificationsMsg } | { "type": "phone", "data": BridgeToGatewayPhoneMsg } | { "type": "player", "data": BridgeToGatewayPlayerMsg } | { "type": "system", "data": BridgeToGatewaySystemMsg } | { "type": "tunnel", "data": BridgeToGatewayTunnelMsg } | { "type": "voice", "data": BridgeToGatewayVoiceMsg } | { "type": "webapp", "data": BridgeToGatewayWebappMsg } | { "type": "forward", "data": ForwardMessage } | { "type": "error", "data": WireError } | { "type": "ack" } | { "type": "done" };

export type BridgeToGatewayNetMsg = { "event": "fetch", "data": NetFetchRequestMsg } | { "event": "wsOpen", "data": NetWsOpen } | { "event": "wsClose", "data": NetWsClose } | { "event": "wsSend", "data": NetWsSend } | { "event": "streamOpen", "data": NetStreamOpen } | { "event": "streamCancel", "data": NetStreamCancel };

export type BridgeToGatewayNotificationsMsg = { "event": "invokePositive", "data": NotificationInvoke } | { "event": "invokeNegative", "data": NotificationInvoke } | { "event": "ancsAuthStateChanged", "data": AncsAuthState };

export type BridgeToGatewayPhoneMsg = { "event": "answer", "data": PhoneCallAction } | { "event": "accept", "data": PhoneAcceptAction } | { "event": "decline", "data": PhoneCallAction } | { "event": "end", "data": PhoneCallAction } | { "event": "endTyped", "data": PhoneEndAction } | { "event": "hold", "data": PhoneCallAction } | { "event": "unhold", "data": PhoneCallAction } | { "event": "initiate", "data": PhoneInitiateAction } | { "event": "swap" } | { "event": "merge" } | { "event": "mute", "data": PhoneMuteAction } | { "event": "dtmf", "data": PhoneDtmfAction } | { "event": "stateGet" };
 ...
 */
export type BridgeToGatewayPlayerMsg = { "event": "play", "data": PlayUri } | { "event": "queue", "data": QueueUri } | { "event": "pause" } | { "event": "resume" } | { "event": "skipNext" } | { "event": "skipPrev" } | { "event": "skipToIndex", "data": SkipToIndex } | { "event": "seekTo", "data": SeekTo } | { "event": "setShuffle", "data": SetShuffle } | { "event": "setRepeat", "data": SetRepeat } | { "event": "setSpeed", "data": SetSpeed } | { "event": "setCrossfade", "data": SetCrossfade } | { "event": "hint", "data": PlaybackHint };

export type BridgeToGatewaySystemMsg = { "event": "otaProgress", "data": OtaProgress } | { "event": "otaError", "data": OtaError } | { "event": "otaBeginAck", "data": OtaBeginAck } | { "event": "otaBeginRejected", "data": OtaBeginRejected } | { "event": "otaAssetRange", "data": OtaAssetRange } | { "event": "otaAssetRangeAbandon", "data": OtaAssetRangeAbandon } | { "event": "deviceNickname", "data": DeviceNicknameReply } | { "event": "deviceNicknameRejected", "data": DeviceNicknameRejected } | { "event": "deviceNicknameChanged", "data": DeviceNicknameReply };

export type BridgeToGatewayTunnelMsg = { "event": "open", "data": TunnelOpen } | { "event": "data", "data": TunnelData } | { "event": "close", "data": TunnelClosed };

export type BridgeToGatewayVoiceMsg = { "event": "streamOpen", "data": VoiceStreamOpen } | { "event": "frame", "data": VoiceFrame } | { "event": "streamClose", "data": VoiceStreamClose };

export type BridgeToGatewayWebappMsg = { "event": "webapps", "data": WebappList } | { "event": "active", "data": WebappActive } | { "event": "switched", "data": WebappActive } | { "event": "installBeginAck", "data": WebappInstallBeginAck } | { "event": "uninstalled", "data": WebappActive } | { "event": "webappError", "data": WebappError } | { "event": "icon", "data": WebappIconReply } | { "event": "configGet", "data": WebappConfigGetReply } | { "event": "configList", "data": WebappConfigListReply } | { "event": "configAck", "data": WebappConfigAck } | { "event": "webappInstalled", "data": WebappInfo } | { "event": "webappInstallFailed", "data": WebappInstallFailed };
...
export type GatewayToBridgeAssetMsg = { "event": "push", "data": AssetPush } | { "event": "clear", "data": AssetClear } | { "event": "pushBegin", "data": AssetPushBegin } | { "event": "pushChunk", "data": AssetPushChunk } | { "event": "pushAbandon", "data": AssetPushAbandon } | { "event": "got", "data": AssetGotReply } | { "event": "notFound", "data": AssetNotFoundReply };

export type GatewayToBridgeAudioMsg = { "event": "ttsStarted", "data": TtsStarted } | { "event": "ttsEnded", "data": TtsEnded } | { "event": "volumeChanged", "data": VolumeChanged };
 ...
 */
export type GatewayToBridgeAuthorityMsg = { "event": "claim", "data": AuthorityClaim } | { "event": "release", "data": AuthorityRelease };
...
export type GatewayToBridgeGeoMsg = { "event": "position", "data": Position } | { "event": "getOnceReply", "data": GeoGetOnceReply } | { "event": "errorReply", "data": GeoErrorReply };

export type GatewayToBridgeLibraryMsg = { "event": "browseReply", "data": BrowseReply } | { "event": "searchReply", "data": SearchReply } | { "event": "recommendationsReply", "data": RecommendationsReply } | { "event": "favoritesListReply", "data": FavoritesListReply } | { "event": "favoritesContainsReply", "data": FavoritesContainsReply } | { "event": "libraryErrorReply", "data": LibraryErrorReply } | { "event": "favoriteChanged", "data": FavoriteChanged };

export type GatewayToBridgeLyricsMsg = { "event": "lyricsReply", "data": LyricsReply } | { "event": "lyricsErrorReply", "data": LyricsErrorReply };
...
export type GatewayToBridgeMsgData = { "type": "asset", "data": GatewayToBridgeAssetMsg } | { "type": "audio", "data": GatewayToBridgeAudioMsg } | { "type": "authority", "data": GatewayToBridgeAuthorityMsg } | { "type": "capabilities", "data": GatewayToBridgeCapabilitiesMsg } | { "type": "chrome", "data": GatewayToBridgeChromeMsg } | { "type": "geo", "data": GatewayToBridgeGeoMsg } | { "type": "library", "data": GatewayToBridgeLibraryMsg } | { "type": "lyrics", "data": GatewayToBridgeLyricsMsg } | { "type": "net", "data": GatewayToBridgeNetMsg } | { "type": "notifications", "data": GatewayToBridgeNotificationsMsg } | { "type": "phone", "data": GatewayToBridgePhoneMsg } | { "type": "player", "data": GatewayToBridgePlayerMsg } | { "type": "system", "data": GatewayToBridgeSystemMsg } | { "type": "time", "data": GatewayToBridgeTimeMsg } | { "type": "tunnel", "data": GatewayToBridgeTunnelMsg } | { "type": "voice", "data": GatewayToBridgeVoiceMsg } | { "type": "webapp", "data": GatewayToBridgeWebappMsg } | { "type": "error", "data": WireError };

export type GatewayToBridgeNetMsg = { "event": "fetchReply", "data": NetFetchReply } | { "event": "fetchErrorReply", "data": NetFetchErrorReply } | { "event": "wsOpenReply", "data": NetWsOpenReply } | { "event": "wsErrorReply", "data": NetWsErrorReply } | { "event": "wsMessage", "data": NetWsMessage } | { "event": "wsClosed", "data": NetWsClosed } | { "event": "wsErrorEvent", "data": NetWsErrorEvent } | { "event": "streamBegin", "data": StreamBegin } | { "event": "streamChunk", "data": StreamChunk } | { "event": "streamEnd", "data": StreamEnd } | { "event": "streamError", "data": StreamError };

export type GatewayToBridgeNotificationsMsg = { "event": "posted", "data": Notification } | { "event": "updated", "data": Notification } | { "event": "removed", "data": NotificationRemoved };

export type GatewayToBridgePhoneMsg = { "event": "snapshot", "data": PhoneStateReply } | { "event": "communicationsSnapshot", "data": CommunicationsSnapshot } | { "event": "callStarted", "data": PhoneCall } | { "event": "callUpdated", "data": PhoneCall } | { "event": "callEnded", "data": PhoneCallEnded } | { "event": "stateReply", "data": PhoneStateReply };
 ...
 */
export type GatewayToBridgePlayerMsg = { "event": "snapshot", "data": PlayerState } | { "event": "delta", "data": NowPlayingUpdate } | { "event": "queueChanged", "data": QueueSnapshot };

export type GatewayToBridgeSystemMsg = { "event": "otaBegin", "data": OtaBegin } | { "event": "otaChunk", "data": OtaChunk } | { "event": "otaAbandon", "data": OtaAbandon } | { "event": "cancelUpdate" } | { "event": "otaAssetRangeReply", "data": OtaAssetRangeReply } | { "event": "otaAssetRangeRejected", "data": OtaAssetRangeRejected } | { "event": "otaAssetRangeChunk", "data": OtaAssetRangeChunk } | { "event": "deviceGetNickname" } | { "event": "deviceSetNickname", "data": DeviceSetNickname };
...
export type GatewayToBridgeTunnelMsg = { "event": "openReply", "data": TunnelOpenReply } | { "event": "errorReply", "data": TunnelErrorReply } | { "event": "data", "data": TunnelData } | { "event": "closed", "data": TunnelClosed };

export type GatewayToBridgeVoiceMsg = { "event": "micOpen", "data": VoiceMicOpen } | { "event": "micClose" };

export type GatewayToBridgeWebappMsg = { "event": "list" } | { "event": "getActive" } | { "event": "switchTo", "data": WebappSwitchTo } | { "event": "installBegin", "data": WebappInstallBegin } | { "event": "installChunk", "data": WebappInstallChunk } | { "event": "installAbandon", "data": WebappInstallAbandon } | { "event": "uninstall", "data": WebappUninstall } | { "event": "icon", "data": WebappIcon } | { "event": "configGet", "data": WebappConfigGet } | { "event": "configList", "data": WebappConfigList } | { "event": "configSet", "data": WebappConfigSet } | { "event": "configDelete", "data": WebappConfigDelete };
 ...
 */
nodeId: string | null, limit: number, offset: number, };
 ...
 */
export type LibraryRecommendationsRequest = { seeds: Array<ItemRef>, kind: ItemKind | null, limit: number, offset: number, };
 ...
 */
export type PlaybackHint = { appBundle: string | null, persistentId: string | null, playing: boolean | null, durationMs: number | null, };
 ...
 */
export type TrackIdentity = { artist: string, track: string, album: string | null, durationMs: number | null, isrc: string | null, };
