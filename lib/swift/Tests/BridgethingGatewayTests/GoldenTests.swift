...
final class GoldenTests: XCTestCase {
  ...
  private func loadGoldens() throws -> GoldenFile {
    // #filePath: …/lib/swift/Tests/BridgethingGatewayTests/GoldenTests.swift
    // Up three levels lands at lib/swift/, then sibling fixtures/ lives at
    // lib/fixtures/, two ups from the test file plus "fixtures/golden.json".
